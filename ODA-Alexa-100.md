...
- Ensure that the **Skills** tab is selected.

- Click **Create Skill**.

<img src="images/100ODA/alexa-create-skill-1.png" alt="">

- Enter your skill name. Under **Choose a model to add**, select "Custom". Under **Choose a method to host your skill's backend resources**, select "Provision your own". Finally, click **Create Skill**.
...
- Under **Skill Invocation Name**, enter the phrase you would like to invoke the bot.
...
- Enter a value for your slot into the **Slot Values** textbox and press enter.
...
- Select **Create custom intent** and enter *exactly* `CommandBot` for your intent name. Any other intent name will cause an error when testing the integration since the Node Server (lab 200) searches for a "CommandBot" intent.
